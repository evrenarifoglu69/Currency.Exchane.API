...
namespace Currency.Exchange.EntityFramework.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(CurrencyExchangeDbContext dbContext, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            return new RepositoryAsync<T>(_dbContext, _httpContextAccessor);
        }
